...
from paths import (
    ...
    get_token_path,
    CREDENTIALS_PATH as DEFAULT_CREDENTIALS_DIR,
    CLIENT_SECRET_FILE as DEFAULT_CLIENT_SECRET_PATH,
    TOKEN_FILE as DEFAULT_TOKEN_PATH,
)

# 後方互換性のため、パス設定関数とDEFAULT_*変数はpaths.pyからre-exportされている
