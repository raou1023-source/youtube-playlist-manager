...
class PlaylistManagerGUI:
    ...
    REGION_TABS = {
        "アジア": ["japan", "korea", "china", "india", "thailand", "vietnam", "philippines", "indonesia"],
        "ヨーロッパ": ["uk", "france", "germany", "italy", "spain", "netherlands", "sweden", "norway", "denmark", "poland", "russia"],
        "北米・南米": ["usa", "canada", "mexico", "brazil", "argentina"],
        "その他": ["worldwide", "africa", "middle_east", "australia", "new_zealand"],
    }
